...
class DetailMinuman extends StatefulWidget {
  ...
  DetailMinuman({required this.productMinuman});
...
class _DetailMinumanState extends State<DetailMinuman> {
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Expanded(
                child: Text(
                    "ID Product Food : ${widget.productMinuman.id}",
                    style: TextStyle(
                        fontSize: 18,
            ...
            Padding(
              ...
              child: Expanded(
                child: Text(
                    "Name Product Food : ${widget.productMinuman.namaMinuman}",
                    style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                        fontStyle: FontStyle.normal)),
            ...
            Padding(
              ...
              child: Expanded(
                child: Text(
                    "Price Product Food : ${widget.productMinuman.hargaMinuman}",
                    style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                        fontStyle: FontStyle.normal)),
            ...
            Padding(
              ...
              child: Expanded(
                child: Text(
                    "Stock Product Food : ${widget.productMinuman.stockMinuman}",
                    style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                        fontStyle: FontStyle.normal)),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Detail Product Drink"),
        centerTitle: true,
      ),
      backgroundColor: Colors.blueAccent,
      body: _ProductDetailDrink(),
    );
  }
}
